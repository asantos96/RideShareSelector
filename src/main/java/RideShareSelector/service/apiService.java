...
//        return restTemplate.getForObject("https://maps.googleapis.com/maps/api/distancematrix/json?origins=" + streetNumber + "%20" + streetName +  "%20First%20Avenue%2C%20Baltimore%2C%20MD&destinations=15%20West%20North%20Avenue%2C%20Baltimore%2C%20MD&units=imperial&key=AIzaSyC92D7nxoEuB7-Epx6wBw-iNjdEIELhGkY", MapData.class);)
    }//end accessMapData
